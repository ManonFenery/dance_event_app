...
event4 = Event.create!(title: "Spectacle", description: Faker::Quotes::Shakespeare.hamlet_quote, start_date: Faker::Date.forward(5), price: Faker::Number.number(2), location_name: "Bercy Hotel Arena", location_address: "10 rue Fontaine", location_zipcode: "75014", location_city: Faker::Address.city, location_country: "France", category: "Spectable", styles: ["All Styles", "Locking", "Break", "Popping", "House"], admin_id: User.all.sample.id)
